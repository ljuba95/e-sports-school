			...
			switch (window.location.search.slice(1,window.location.search.length)){
				...
				case "CSGO":
					injectHtml = injectHtml.replace('text','<p><a href="http://blog.counter-strike.net/" class="upis-links"><strong>&emsp;&emsp;Counter Strike: Global Offensive</strong></a> je najpopularnija <a class="masterTooltip upis-links" title="First Person Shooter - Pucačina u prvom licu."><strong>FPS</strong></a> video igra na svetu.' +
						...
						' ekspertno izvršite <a class="masterTooltip upis-links" title="Potez kada igrač rafalno puca iz puške i povećava šanse da ubije jednog ili više protivnika, ukoliko to izvrši precizno."><strong>spray</strong></a>, budete izvrstan <a class="masterTooltip upis-links" title="Arctic Warfare Police sniper rifle - Snajperska puška."><strong>AWP</strong></a> igrač itd. neka su od znanja koja ćete steći aktivnim angažovanjem u našoj ustanovi.</p>');
					break;
