			...
			switch (window.location.search.slice(1,window.location.search.length)){
				...
				case "CSGO":
					injectHtml = injectHtml.replace('text','<a href="http://blog.counter-strike.net/" class="upis-links"><strong>&emsp;&emsp;Counter Strike: Global Offensive</strong></a> je najpopularnija <a class="masterTooltip upis-links" title="First Person Shooter - Pucačina u prvom licu."><strong>FPS</strong></a> video igra na svetu.' +
						' Zbog prirode igre (brza, eksplozivna, zahteva brze reakcije i izvrsnu preciznost), spada u jednu od najtežih igara za <a class="masterTooltip upis-links" title="Proces ovladavanja nekom veštinom do najvišeg mogućeg nivoa."><strong>master-ovanje</strong></a>.' +
						' Kako se timovi sastoje od 5 igrača, jako je važna brza i jasna komunikacija i zbog toga, pored beneficije sticanja znanja kako biti efikasan igrač, možete očekivati da će se vaš <a class="masterTooltip upis-links" title="Sposobnost saradnje sa saigračima u timu i ostvarivanje jedinke koja je više od zbira njenih članica."><strong>teamwork</strong></a> znatno poboljšati.' +
						' Kako je osnovni cilj u takmičarskom counter strike-u pobediti u 16 rundi pre protivnika, jako je važan <a class="masterTooltip upis-links" title="Ekonomija u counter strike-u, koliko uspešno, i kada gubi i kada pobeđuje, tim kontroliše svoj i protivnikov novac kojim se kupuju puške, granate itd."><strong>economy</strong></a>, <a class="masterTooltip upis-links" title="Sposobnost tima da kontroliše i ograničava kretanje suparničkog tima na celoj mapi, primorava protivnike da igraju reaktivno i stiče poziciju u kojoj diktira tok igre."><strong>map control</strong></a>' +
						' i odigravanje <a class="masterTooltip upis-links" title="Potezi kojima igrač, bez velikog rizika, polako i sigurno, ostvaruje prednost nad protivnikom."><strong>low risk-high reward poteza</strong></a>.' +
						' Kako optimalno da odigrate <a class="masterTooltip upis-links" title="Situacija kada je igrač opkoljen sa više protivničkih igrača iz različitih uglova u isto vreme."><strong>cross-fire situaciju</strong></a>, uradite <a class="masterTooltip upis-links" title="Potez kada igrač deaktivira bombu u trenutku kada protivnički tim to ne očekuje ili u žaru borbe pomoću dimnih bombi."><strong>ninja-defuse</strong></a>, u većini slučajeva uzmete <a class="masterTooltip upis-links" title="Potez kada igrač ubije jednog ili više protivnika, dok se prvi probija na vidno polje istih."><strong>entry-frag</strong></a>' +
						...
						' ekspertno izvršite <a class="masterTooltip upis-links" title="Potez kada igrač rafalno puca iz puške i povećava šanse da ubije jednog ili više protivnika, ukoliko to izvrši precizno."><strong>spray</strong></a>, budete izvrstan <a class="masterTooltip upis-links" title="Arctic Warfare Police sniper rifle - Snajperska puška."><strong>AWP</strong></a> igrač itd. neka su od znanja koja ćete steći aktivnim angažovanjem u našoj ustanovi.');
					break;
